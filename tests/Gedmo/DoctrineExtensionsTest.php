...
final class DoctrineExtensionsTest extends TestCase
{
    public function testRegistersAttributeDriverForConcreteOrmEntitiesToChain(): void
    {
        ...
        static::assertInstanceOf(DriverORM\AttributeDriver::class, $drivers['Gedmo'], 'The attribute driver should be registered to the chain');
    }
    ...
    public function testRegistersAttributeDriverForConcreteOdmDocumentsToChain(): void
    {
        ...
        static::assertArrayHasKey('Gedmo', $drivers);
        static::assertInstanceOf(DriverMongodbODM\AttributeDriver::class, $drivers['Gedmo'], 'The attribute driver should be registered to the chain');
    }
