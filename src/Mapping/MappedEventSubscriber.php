...
abstract class MappedEventSubscriber implements EventSubscriber
{
     ...
     *
     * @var AttributeReader|false
     */
    private $attributeReader = false;

    private static ?AttributeReader $defaultAttributeReader = null;
    ...
    public function getExtensionMetadataFactory(ObjectManager $objectManager)
    {
        ...
        if (!isset($this->extensionMetadataFactory[$oid])) {
            if (false === $this->attributeReader) {
                // create default attribute reader for extensions
                $this->attributeReader = $this->getDefaultAttributeReader();
            }
    ...
    /**
     * Get the default attribute reader for extensions, creating it if necessary.
     */
    private function getDefaultAttributeReader(): AttributeReader
    {
        return self::$defaultAttributeReader ?? new AttributeReader();
    }
